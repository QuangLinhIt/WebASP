    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderConfiguration", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderConfiguration_AppUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_OrderConfiguration_OrderId",
                        column: x => x.OrderId,
                        principalTable: "OrderConfiguration",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "aa0d0fab-fcc8-4e7a-bbe6-3d0350dbd8a1", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "9c056875-87fd-4c11-b569-2daa6f027dec", new DateTime(2020, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "quang2001linh@gmail.com", true, "Toan", "Bach", false, null, "quang2001linh@gmail.com", "admin", "AQAAAAEAACcQAAAAEFrTlxryRTAFIOY4yKzn4h5Lqhb82sS4JuU4R0vcjHY6D70cDD7Nqd9ySe5k9Fl6Rw==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 6, 26, 16, 3, 8, 656, DateTimeKind.Local).AddTicks(2809), 100000m, 200000m, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderConfiguration_UserId",
                table: "OrderConfiguration",
                column: "UserId");
